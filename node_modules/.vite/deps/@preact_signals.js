...
function a(i2) {
  if (void 0 !== r) {
    var t3 = i2.n;
    if (void 0 === t3 || t3.t !== r) {
      t3 = { i: 0, S: i2, p: r.s, n: void 0, t: r, e: void 0, x: void 0, r: t3 };
...
l2.prototype.brand = i;
l2.prototype.h = function() {
  return true;
};
...
l2.prototype.subscribe = function(i2) {
  var t3 = this;
  return j(function() {
...
p.prototype.S = function(i2) {
  ...
  l2.prototype.S.call(this, i2);
};
p.prototype.U = function(i2) {
  if (void 0 !== this.t) {
    l2.prototype.U.call(this, i2);
    if (void 0 === this.t) {
      this.f &= -33;
...
h2.displayName = "_st";
Object.defineProperties(l2.prototype, { constructor: { configurable: true, value: void 0 }, type: { configurable: true, value: h2 }, props: { configurable: true, get: function() {
  return { data: this };
} }, __b: { configurable: true, value: 1 } });
l3("__b", function(i2, r2) {
  if ("string" == typeof r2.type) {
    var n2, t3 = r2.props;
    for (var f2 in t3) if ("children" !== f2) {
      var o2 = t3[f2];
      if (o2 instanceof l2) {
        if (!n2) r2.__np = n2 = {};
        n2[f2] = o2;
...
l3("__r", function(i2, r2) {
  ...
  if (t3) {
    t3.__$f &= -2;
    if (void 0 === (n2 = t3.__$u)) t3.__$u = n2 = (function(i3) {
      var r3;
      j(function() {
        r3 = this;
      });
...
function p2(i2, r2, n2, t3) {
  var f2 = r2 in i2 && void 0 === i2.ownerSVGElement, o2 = y2(n2);
...
l3("__h", function(i2, r2, n2, t3) {
  if (t3 < 3 || 9 === t3) r2.__$f |= 2;
  i2(r2, n2, t3);
});
C.prototype.shouldComponentUpdate = function(i2, r2) {
