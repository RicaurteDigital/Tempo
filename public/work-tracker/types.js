...
const DEFAULT_TAX_PROFILES = {
  ...
  'NY': { label: 'New York State — ~6.85%',       federal:22, socialSecurity:6.2, medicare:1.45, state:6.85, local:0,     pfl:0.388,otherLabel:'PFL',   other:0 },
  'NY_NYC': { label: 'New York City — ~6.85% + 3.876% NYC', federal:22, socialSecurity:6.2, medicare:1.45, state:6.85, local:3.876, pfl:0.388, otherLabel:'PFL', other:0 },
