  ...
  function _Week() {
    ...
    w.innerHTML = `
      <div class="wt-hdr">
        ...
        <button id="wt-home-icon" style="width:40px;height:40px;border-radius:50%;background:rgba(48,209,88,.15);border:1px solid rgba(48,209,88,.4);color:#30D158;font-size:18px;display:flex;align-items:center;justify-content:center;cursor:pointer">⌂</button>
      </div>`;
